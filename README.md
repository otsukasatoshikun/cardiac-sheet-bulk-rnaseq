...
│   ├── signatures.gmt         Gene-set definitions (ATRIAL_CLEAN, VENTRICULAR, IMMATURE, MATURE)
...
|---|---|---|
| Bulk RNA-seq (this study) | NCBI GEO: **GSEXXXXXX** *(to be released upon publication)* | `data/bulk/real_bulk_counts.tsv`, `data/bulk/real_bulk_meta.tsv` |
